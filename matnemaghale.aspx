<%@ Page Title="" Language="C#" MasterPageFile="~/maghalat.Master" AutoEventWireup="true" CodeBehind="matnemaghale.aspx.cs" Inherits="WebApplication1.matnemaghale" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_matnemaghale" runat="server">
     <%Response.Write(BodyContent_html_matnemaghalat); %>
</asp:Content>
<div></div>