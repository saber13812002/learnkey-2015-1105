<%@ Page Title="" Language="C#" MasterPageFile="~/maghalat.Master" AutoEventWireup="true" CodeBehind="sharhenews.aspx.cs" Inherits="WebApplication1.sharhenews" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_matnemaghale" runat="server">
     <%Response.Write(BodyContent_html_sharhenews); %>
</asp:Content>
